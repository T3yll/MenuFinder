        ...
        <div className="flex justify-between h-16">
          <div className="flex">
            <div className="flex-shrink-0 flex items-center">
              <Link to="/" className={`${isAuthPage ? 'text-white' : 'text-primary'}`} style={{ textDecoration: 'none' }}>
                <img src="/images/Plan_de_travail_1_copie_2-20.jpg" alt="King Eats" className="h-6 w-auto object-contain" />
              </Link>
            </div>
            {!isAuthPage && (
    ...
    <Router>
      <div className="min-h-screen bg-light text-dark">
        <Routes>
          ...
          <Route path="/restaurants" element={<><Navigation /><Restaurants /></>} />
          <Route path="/menus" element={<><Navigation /><Menus /></>} />
        </Routes>
      </div>
    </Router>
  );
